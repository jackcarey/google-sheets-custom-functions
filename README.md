...
* **RANDOM** - Return a random number between 1 and 0, or between a range. This function replicated RAND() and RANDBETWEEN, so random values can be used as inputs to custom functions.
