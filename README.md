...
* **FORMULATEXT** - Return the forumula for a given cell. Now redundent, use the built-in FORMULA() function instead.
...
* **TRANSLATE** - Translate strings from one language to another. Now redundent, use the built-in GOOGLETRANSLATE() function instead.
* **UNIQUE_2D** - Return a 1-dimensional list of unique items from a 2D array. Unique values are checked by cell content, not whoel row content.
